/********** GENERATED on 08/14/2018 at 10:58:13 by CB0000000021**************/
 ...
 define root abstract entity /DMO/A_BPCONTACTTOADDRESS { 
...
//On-condition is not relevant for runtime 
 _EmailAddress : association [0..*] to /DMO/A_ADDRESSEMAILADDRESS on /DMO/A_BPCONTACTTOADDRESS.AddressID = /DMO/A_BPCONTACTTOADDRESS.AddressID; 
 @OData.property.name: 'to_FaxNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _FaxNumber : association [0..*] to /DMO/A_ADDRESSFAXNUMBER on /DMO/A_BPCONTACTTOADDRESS.AddressID = /DMO/A_BPCONTACTTOADDRESS.AddressID; 
 @OData.property.name: 'to_MobilePhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _MobilePhoneNumber : association [0..*] to /DMO/A_ADDRESSPHONENUMBER on /DMO/A_BPCONTACTTOADDRESS.AddressID = /DMO/A_BPCONTACTTOADDRESS.AddressID; 
 @OData.property.name: 'to_PhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PhoneNumber : association [0..*] to /DMO/A_ADDRESSPHONENUMBER on /DMO/A_BPCONTACTTOADDRESS.AddressID = /DMO/A_BPCONTACTTOADDRESS.AddressID; 
 @OData.property.name: 'to_URLAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _URLAddress : association [0..*] to /DMO/A_ADDRESSHOMEPAGEURL on /DMO/A_BPCONTACTTOADDRESS.AddressID = /DMO/A_BPCONTACTTOADDRESS.AddressID; 
 } 
